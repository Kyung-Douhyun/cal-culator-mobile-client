...
// import LoginTypes from '../../temp/LoginTypes';
import { connect } from 'react-redux';
import axios from 'axios';
// import ModifyModal from '../About/components/ModifyModal';
...
function Login({ userInfo }) {
	...
	// const loginedUser = () => {
	// 	const { id, email, name, age, gender, weight, height } = userInfo;
	// 	setCurUser({ ...curUser, id, email, name, age, gender, height, weight });
	// };
